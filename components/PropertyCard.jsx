...
const PropertyCard = ({ property }) => {
    ...
    /**
     * This functions reads the property rate information and will return a ready to display string
     * depending on the available rate in the property: monthly, weekly, nightly, etc
     * @returns string
     */
